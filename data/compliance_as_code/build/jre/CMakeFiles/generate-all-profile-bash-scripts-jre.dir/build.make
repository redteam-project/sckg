...
bash/all-profile-bash-scripts-jre: ssg-jre-xccdf.xml
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[jre-bash-scripts] generating Bash remediation scripts for all profiles in ssg-jre-xccdf.xml"
	cd /root/content-0.1.47/build/jre && /usr/bin/cmake -E make_directory /root/content-0.1.47/build/bash
	cd /root/content-0.1.47/build/jre && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/build_profile_remediations.py --input /root/content-0.1.47/build/ssg-jre-xccdf.xml --output /root/content-0.1.47/build/bash --template urn:xccdf:fix:script:sh --extension sh build
	cd /root/content-0.1.47/build/jre && /usr/bin/cmake -E touch /root/content-0.1.47/build/bash/all-profile-bash-scripts-jre
...
jre/CMakeFiles/generate-all-profile-bash-scripts-jre.dir/clean:
	cd /root/content-0.1.47/build/jre && $(CMAKE_COMMAND) -P CMakeFiles/generate-all-profile-bash-scripts-jre.dir/cmake_clean.cmake
...
jre/CMakeFiles/generate-all-profile-bash-scripts-jre.dir/depend:
	cd /root/content-0.1.47/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/content-0.1.47 /root/content-0.1.47/jre /root/content-0.1.47/build /root/content-0.1.47/build/jre /root/content-0.1.47/build/jre/CMakeFiles/generate-all-profile-bash-scripts-jre.dir/DependInfo.cmake --color=$(COLOR)
