...
# Utility rule file for generate-ssg-ocp4-guide-index.html.

# Include the progress variables for this target.
include ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/progress.make

ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html: guides/ssg-ocp4-guide-index.html

guides/ssg-ocp4-guide-index.html: ssg-ocp4-ds.xml
guides/ssg-ocp4-guide-index.html: ssg-ocp4-ds-1.2.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_1)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-guides] generating HTML guides for all profiles in ssg-ocp4-ds.xml"
	cd /root/content-0.1.47/build/ocp4 && /usr/bin/cmake -E make_directory /root/content-0.1.47/build/guides
	cd /root/content-0.1.47/build/ocp4 && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/build_all_guides.py --input /root/content-0.1.47/build/ssg-ocp4-ds.xml --output /root/content-0.1.47/build/guides build

ssg-ocp4-ds.xml: ssg-ocp4-xccdf-1.2.xml
ssg-ocp4-ds.xml: ssg-ocp4-oval.xml
ssg-ocp4-ds.xml: ssg-ocp4-ocil.xml
ssg-ocp4-ds.xml: ssg-ocp4-cpe-dictionary.xml
ssg-ocp4-ds.xml: ssg-ocp4-cpe-oval.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_2)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-content] generating ssg-ocp4-ds.xml and ssg-ocp4-ds-1.2.xml"
	/bin/oscap ds sds-compose --skip-valid ssg-ocp4-xccdf-1.2.xml /root/content-0.1.47/build/ssg-ocp4-ds.xml
	/bin/sed -i 's/schematron-version="[0-9].[0-9]"/schematron-version="1.2"/' /root/content-0.1.47/build/ssg-ocp4-ds.xml
	/bin/oscap ds sds-add --skip-valid ssg-ocp4-cpe-dictionary.xml /root/content-0.1.47/build/ssg-ocp4-ds.xml
	env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/sds_move_ocil_to_checks.py /root/content-0.1.47/build/ssg-ocp4-ds.xml /root/content-0.1.47/build/ssg-ocp4-ds.xml
	env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/update_sds_version.py --version 1.2 --input /root/content-0.1.47/build/ssg-ocp4-ds.xml --output /root/content-0.1.47/build/ssg-ocp4-ds-1.2.xml
	env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/update_sds_version.py --version 1.3 --input /root/content-0.1.47/build/ssg-ocp4-ds.xml --output /root/content-0.1.47/build/ssg-ocp4-ds.xml
	/bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-ds.xml /root/content-0.1.47/build/ssg-ocp4-ds.xml
	/bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-ds-1.2.xml /root/content-0.1.47/build/ssg-ocp4-ds-1.2.xml

ssg-ocp4-ds-1.2.xml: ssg-ocp4-ds.xml

ssg-ocp4-xccdf-1.2.xml: ssg-ocp4-xccdf.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_3)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-content] generating ssg-ocp4-xccdf-1.2.xml"
	cd /root/content-0.1.47/build/ocp4 && /bin/xsltproc --stringparam reverse_DNS org.ssgproject.content --output /root/content-0.1.47/build/ssg-ocp4-xccdf-1.2.xml /usr/share/openscap/xsl/xccdf_1.1_to_1.2.xsl /root/content-0.1.47/build/ssg-ocp4-xccdf.xml

ssg-ocp4-oval.xml: ocp4/oval-linked.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_4)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-content] generating ssg-ocp4-oval.xml"
	cd /root/content-0.1.47/build/ocp4 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-oval.xml /root/content-0.1.47/build/ocp4/oval-linked.xml

ssg-ocp4-ocil.xml: ocp4/ocil-linked.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_5)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-content] generating ssg-ocp4-ocil.xml"
	cd /root/content-0.1.47/build/ocp4 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-ocil.xml /root/content-0.1.47/build/ocp4/ocil-linked.xml

ssg-ocp4-cpe-dictionary.xml: ocp4/oval-unlinked.xml
ssg-ocp4-cpe-dictionary.xml: ../ocp4/cpe/ocp4-cpe-dictionary.xml
ssg-ocp4-cpe-dictionary.xml: ../build-scripts/cpe_generate.py
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_6)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-content] generating ssg-ocp4-cpe-dictionary.xml, ssg-ocp4-cpe-oval.xml"
	cd /root/content-0.1.47/build/ocp4 && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/cpe_generate.py ocp4 ssg /root/content-0.1.47/build /root/content-0.1.47/build/ocp4/oval-unlinked.xml /root/content-0.1.47/ocp4/cpe/ocp4-cpe-dictionary.xml
	cd /root/content-0.1.47/build/ocp4 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-cpe-dictionary.xml /root/content-0.1.47/build/ssg-ocp4-cpe-dictionary.xml
	cd /root/content-0.1.47/build/ocp4 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-cpe-oval.xml /root/content-0.1.47/build/ssg-ocp4-cpe-oval.xml

ssg-ocp4-cpe-oval.xml: ssg-ocp4-cpe-dictionary.xml

ssg-ocp4-xccdf.xml: ocp4/xccdf-linked.xml
ssg-ocp4-xccdf.xml: ../shared/transforms/shared_xccdf-removeaux.xslt
ssg-ocp4-xccdf.xml: ../build-scripts/unselect_empty_xccdf_groups.py
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_7)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[ocp4-content] generating ssg-ocp4-xccdf.xml"
	cd /root/content-0.1.47/build/ocp4 && /bin/xsltproc --output /root/content-0.1.47/build/ssg-ocp4-xccdf.xml /root/content-0.1.47/shared/transforms/shared_xccdf-removeaux.xslt /root/content-0.1.47/build/ocp4/xccdf-linked.xml
	cd /root/content-0.1.47/build/ocp4 && /bin/sed -i s/oval-linked.xml/ssg-ocp4-oval.xml/g /root/content-0.1.47/build/ssg-ocp4-xccdf.xml
	cd /root/content-0.1.47/build/ocp4 && /bin/sed -i s/ocil-linked.xml/ssg-ocp4-ocil.xml/g /root/content-0.1.47/build/ssg-ocp4-xccdf.xml
	cd /root/content-0.1.47/build/ocp4 && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/unselect_empty_xccdf_groups.py --input /root/content-0.1.47/build/ssg-ocp4-xccdf.xml --output /root/content-0.1.47/build/ssg-ocp4-xccdf.xml
	cd /root/content-0.1.47/build/ocp4 && /bin/oscap xccdf resolve -o /root/content-0.1.47/build/ssg-ocp4-xccdf.xml /root/content-0.1.47/build/ssg-ocp4-xccdf.xml
	cd /root/content-0.1.47/build/ocp4 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-ocp4-xccdf.xml /root/content-0.1.47/build/ssg-ocp4-xccdf.xml
...
generate-ssg-ocp4-guide-index.html: ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html
generate-ssg-ocp4-guide-index.html: guides/ssg-ocp4-guide-index.html
generate-ssg-ocp4-guide-index.html: ssg-ocp4-ds.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-ds-1.2.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-xccdf-1.2.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-oval.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-ocil.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-cpe-dictionary.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-cpe-oval.xml
generate-ssg-ocp4-guide-index.html: ssg-ocp4-xccdf.xml
generate-ssg-ocp4-guide-index.html: ocp4/xccdf-linked.xml
generate-ssg-ocp4-guide-index.html: ocp4/oval-linked.xml
generate-ssg-ocp4-guide-index.html: ocp4/ocil-linked.xml
generate-ssg-ocp4-guide-index.html: ocp4/oval-unlinked.xml
generate-ssg-ocp4-guide-index.html: ocp4/xccdf-unlinked.xml
generate-ssg-ocp4-guide-index.html: ocp4/ocil-unlinked.xml
generate-ssg-ocp4-guide-index.html: ocp4/xccdf-unlinked-ocilrefs.xml
generate-ssg-ocp4-guide-index.html: ocp4/bash-fixes.xml
generate-ssg-ocp4-guide-index.html: ocp4/ansible-fixes.xml
generate-ssg-ocp4-guide-index.html: ocp4/puppet-fixes.xml
generate-ssg-ocp4-guide-index.html: ocp4/anaconda-fixes.xml
generate-ssg-ocp4-guide-index.html: ocp4/xccdf-unlinked-resolved.xml
generate-ssg-ocp4-guide-index.html: ocp4/shorthand.xml
generate-ssg-ocp4-guide-index.html: ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/build.make
.PHONY : generate-ssg-ocp4-guide-index.html

# Rule to build all files generated by this target.
ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/build: generate-ssg-ocp4-guide-index.html
.PHONY : ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/build

ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/clean:
	cd /root/content-0.1.47/build/ocp4 && $(CMAKE_COMMAND) -P CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/cmake_clean.cmake
.PHONY : ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/clean

ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/depend:
	cd /root/content-0.1.47/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/content-0.1.47 /root/content-0.1.47/ocp4 /root/content-0.1.47/build /root/content-0.1.47/build/ocp4 /root/content-0.1.47/build/ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/DependInfo.cmake --color=$(COLOR)
.PHONY : ocp4/CMakeFiles/generate-ssg-ocp4-guide-index.html.dir/depend
