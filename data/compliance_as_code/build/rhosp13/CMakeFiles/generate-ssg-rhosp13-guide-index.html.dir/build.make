...
guides/ssg-rhosp13-guide-index.html: ssg-rhosp13-ds-1.2.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_1)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[rhosp13-guides] generating HTML guides for all profiles in ssg-rhosp13-ds.xml"
	cd /root/content-0.1.47/build/rhosp13 && /usr/bin/cmake -E make_directory /root/content-0.1.47/build/guides
	cd /root/content-0.1.47/build/rhosp13 && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/build_all_guides.py --input /root/content-0.1.47/build/ssg-rhosp13-ds.xml --output /root/content-0.1.47/build/guides build

ssg-rhosp13-ds.xml: ssg-rhosp13-xccdf-1.2.xml
ssg-rhosp13-ds.xml: ssg-rhosp13-oval.xml
ssg-rhosp13-ds.xml: ssg-rhosp13-ocil.xml
ssg-rhosp13-ds.xml: ssg-rhosp13-cpe-dictionary.xml
ssg-rhosp13-ds.xml: ssg-rhosp13-cpe-oval.xml
	$(CMAKE_COMMAND) -E cmake_progress_report /root/content-0.1.47/build/CMakeFiles $(CMAKE_PROGRESS_2)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[rhosp13-content] generating ssg-rhosp13-ds.xml and ssg-rhosp13-ds-1.2.xml"
	/bin/oscap ds sds-compose --skip-valid ssg-rhosp13-xccdf-1.2.xml /root/content-0.1.47/build/ssg-rhosp13-ds.xml
	/bin/sed -i 's/schematron-version="[0-9].[0-9]"/schematron-version="1.2"/' /root/content-0.1.47/build/ssg-rhosp13-ds.xml
	/bin/oscap ds sds-add --skip-valid ssg-rhosp13-cpe-dictionary.xml /root/content-0.1.47/build/ssg-rhosp13-ds.xml
	env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/sds_move_ocil_to_checks.py /root/content-0.1.47/build/ssg-rhosp13-ds.xml /root/content-0.1.47/build/ssg-rhosp13-ds.xml
	env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/update_sds_version.py --version 1.2 --input /root/content-0.1.47/build/ssg-rhosp13-ds.xml --output /root/content-0.1.47/build/ssg-rhosp13-ds-1.2.xml
	env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/update_sds_version.py --version 1.3 --input /root/content-0.1.47/build/ssg-rhosp13-ds.xml --output /root/content-0.1.47/build/ssg-rhosp13-ds.xml
	/bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-rhosp13-ds.xml /root/content-0.1.47/build/ssg-rhosp13-ds.xml
	/bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-rhosp13-ds-1.2.xml /root/content-0.1.47/build/ssg-rhosp13-ds-1.2.xml

ssg-rhosp13-ds-1.2.xml: ssg-rhosp13-ds.xml
...
ssg-rhosp13-xccdf-1.2.xml: ssg-rhosp13-xccdf.xml
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[rhosp13-content] generating ssg-rhosp13-xccdf-1.2.xml"
	cd /root/content-0.1.47/build/rhosp13 && /bin/xsltproc --stringparam reverse_DNS org.ssgproject.content --output /root/content-0.1.47/build/ssg-rhosp13-xccdf-1.2.xml /usr/share/openscap/xsl/xccdf_1.1_to_1.2.xsl /root/content-0.1.47/build/ssg-rhosp13-xccdf.xml
...
ssg-rhosp13-oval.xml: rhosp13/oval-linked.xml
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[rhosp13-content] generating ssg-rhosp13-oval.xml"
	cd /root/content-0.1.47/build/rhosp13 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-rhosp13-oval.xml /root/content-0.1.47/build/rhosp13/oval-linked.xml
...
ssg-rhosp13-ocil.xml: rhosp13/ocil-linked.xml
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[rhosp13-content] generating ssg-rhosp13-ocil.xml"
	cd /root/content-0.1.47/build/rhosp13 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-rhosp13-ocil.xml /root/content-0.1.47/build/rhosp13/ocil-linked.xml

ssg-rhosp13-cpe-dictionary.xml: rhosp13/oval-unlinked.xml
ssg-rhosp13-cpe-dictionary.xml: ../rhosp13/cpe/rhosp13-cpe-dictionary.xml
ssg-rhosp13-cpe-dictionary.xml: ../build-scripts/cpe_generate.py
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[rhosp13-content] generating ssg-rhosp13-cpe-dictionary.xml, ssg-rhosp13-cpe-oval.xml"
	cd /root/content-0.1.47/build/rhosp13 && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/cpe_generate.py rhosp13 ssg /root/content-0.1.47/build /root/content-0.1.47/build/rhosp13/oval-unlinked.xml /root/content-0.1.47/rhosp13/cpe/rhosp13-cpe-dictionary.xml
	cd /root/content-0.1.47/build/rhosp13 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-rhosp13-cpe-dictionary.xml /root/content-0.1.47/build/ssg-rhosp13-cpe-dictionary.xml
	cd /root/content-0.1.47/build/rhosp13 && /bin/xmllint --nsclean --format --output /root/content-0.1.47/build/ssg-rhosp13-cpe-oval.xml /root/content-0.1.47/build/ssg-rhosp13-cpe-oval.xml
...
generate-ssg-rhosp13-guide-index.html: ssg-rhosp13-ds-1.2.xml
...
rhosp13/CMakeFiles/generate-ssg-rhosp13-guide-index.html.dir/clean:
	cd /root/content-0.1.47/build/rhosp13 && $(CMAKE_COMMAND) -P CMakeFiles/generate-ssg-rhosp13-guide-index.html.dir/cmake_clean.cmake
...
rhosp13/CMakeFiles/generate-ssg-rhosp13-guide-index.html.dir/depend:
	cd /root/content-0.1.47/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/content-0.1.47 /root/content-0.1.47/rhosp13 /root/content-0.1.47/build /root/content-0.1.47/build/rhosp13 /root/content-0.1.47/build/rhosp13/CMakeFiles/generate-ssg-rhosp13-guide-index.html.dir/DependInfo.cmake --color=$(COLOR)
