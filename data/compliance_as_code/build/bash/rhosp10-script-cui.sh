...
###############################################################################
# BEGIN fix (2 / 36) for 'keystone_disable_admin_token'
###############################################################################
(>&2 echo "Remediating rule 2/36: 'keystone_disable_admin_token'")
(>&2 echo "FIX FOR THIS RULE 'keystone_disable_admin_token' IS MISSING!")
# END fix for 'keystone_disable_admin_token'

###############################################################################
# BEGIN fix (3 / 36) for 'keystone_lockout_duration'
###############################################################################
(>&2 echo "Remediating rule 3/36: 'keystone_lockout_duration'")
(>&2 echo "FIX FOR THIS RULE 'keystone_lockout_duration' IS MISSING!")
# END fix for 'keystone_lockout_duration'

###############################################################################
# BEGIN fix (4 / 36) for 'keystone_lockout_failure_attempts'
###############################################################################
(>&2 echo "Remediating rule 4/36: 'keystone_lockout_failure_attempts'")
...
###############################################################################
# BEGIN fix (6 / 36) for 'keystone_max_request_body_size'
###############################################################################
(>&2 echo "Remediating rule 6/36: 'keystone_max_request_body_size'")
(>&2 echo "FIX FOR THIS RULE 'keystone_max_request_body_size' IS MISSING!")
# END fix for 'keystone_max_request_body_size'

###############################################################################
# BEGIN fix (7 / 36) for 'keystone_algorithm_hashing'
###############################################################################
(>&2 echo "Remediating rule 7/36: 'keystone_algorithm_hashing'")
...
###############################################################################
# BEGIN fix (9 / 36) for 'keystone_use_ssl'
###############################################################################
(>&2 echo "Remediating rule 9/36: 'keystone_use_ssl'")
(>&2 echo "FIX FOR THIS RULE 'keystone_use_ssl' IS MISSING!")
# END fix for 'keystone_use_ssl'

###############################################################################
# BEGIN fix (10 / 36) for 'nova_use_keystone'
###############################################################################
(>&2 echo "Remediating rule 10/36: 'nova_use_keystone'")
...
###############################################################################
# BEGIN fix (12 / 36) for 'nova_secure_authentication'
###############################################################################
(>&2 echo "Remediating rule 12/36: 'nova_secure_authentication'")
(>&2 echo "FIX FOR THIS RULE 'nova_secure_authentication' IS MISSING!")
# END fix for 'nova_secure_authentication'

###############################################################################
# BEGIN fix (13 / 36) for 'nova_file_perms'
###############################################################################
(>&2 echo "Remediating rule 13/36: 'nova_file_perms'")
(>&2 echo "FIX FOR THIS RULE 'nova_file_perms' IS MISSING!")
# END fix for 'nova_file_perms'

###############################################################################
# BEGIN fix (14 / 36) for 'nova_secure_glance'
###############################################################################
(>&2 echo "Remediating rule 14/36: 'nova_secure_glance'")
...
###############################################################################
# BEGIN fix (16 / 36) for 'horizon_password_autocomplete'
###############################################################################
(>&2 echo "Remediating rule 16/36: 'horizon_password_autocomplete'")
...
###############################################################################
# BEGIN fix (19 / 36) for 'horizon_csrf_cookie_secure'
###############################################################################
(>&2 echo "Remediating rule 19/36: 'horizon_csrf_cookie_secure'")
(>&2 echo "FIX FOR THIS RULE 'horizon_csrf_cookie_secure' IS MISSING!")
# END fix for 'horizon_csrf_cookie_secure'

###############################################################################
# BEGIN fix (20 / 36) for 'horizon_file_perms'
###############################################################################
(>&2 echo "Remediating rule 20/36: 'horizon_file_perms'")
(>&2 echo "FIX FOR THIS RULE 'horizon_file_perms' IS MISSING!")
# END fix for 'horizon_file_perms'

###############################################################################
# BEGIN fix (21 / 36) for 'horizon_session_cookie_httponly'
###############################################################################
(>&2 echo "Remediating rule 21/36: 'horizon_session_cookie_httponly'")
...
###############################################################################
# BEGIN fix (23 / 36) for 'cinder_nova_tls'
###############################################################################
(>&2 echo "Remediating rule 23/36: 'cinder_nova_tls'")
(>&2 echo "FIX FOR THIS RULE 'cinder_nova_tls' IS MISSING!")
# END fix for 'cinder_nova_tls'

###############################################################################
# BEGIN fix (24 / 36) for 'cinder_nas_secure_file_permissions'
###############################################################################
(>&2 echo "Remediating rule 24/36: 'cinder_nas_secure_file_permissions'")
...
###############################################################################
# BEGIN fix (29 / 36) for 'cinder_tls_enabled'
###############################################################################
(>&2 echo "Remediating rule 29/36: 'cinder_tls_enabled'")
(>&2 echo "FIX FOR THIS RULE 'cinder_tls_enabled' IS MISSING!")
# END fix for 'cinder_tls_enabled'

###############################################################################
# BEGIN fix (30 / 36) for 'cinder_file_ownership'
###############################################################################
(>&2 echo "Remediating rule 30/36: 'cinder_file_ownership'")
...
###############################################################################
# BEGIN fix (32 / 36) for 'neutron_file_perms'
###############################################################################
(>&2 echo "Remediating rule 32/36: 'neutron_file_perms'")
(>&2 echo "FIX FOR THIS RULE 'neutron_file_perms' IS MISSING!")
# END fix for 'neutron_file_perms'

###############################################################################
# BEGIN fix (33 / 36) for 'neutron_use_keystone'
###############################################################################
(>&2 echo "Remediating rule 33/36: 'neutron_use_keystone'")
(>&2 echo "FIX FOR THIS RULE 'neutron_use_keystone' IS MISSING!")
# END fix for 'neutron_use_keystone'

###############################################################################
# BEGIN fix (34 / 36) for 'neutron_use_https'
###############################################################################
(>&2 echo "Remediating rule 34/36: 'neutron_use_https'")
(>&2 echo "FIX FOR THIS RULE 'neutron_use_https' IS MISSING!")
# END fix for 'neutron_use_https'

###############################################################################
# BEGIN fix (35 / 36) for 'neutron_api_use_ssl'
###############################################################################
(>&2 echo "Remediating rule 35/36: 'neutron_api_use_ssl'")
(>&2 echo "FIX FOR THIS RULE 'neutron_api_use_ssl' IS MISSING!")
# END fix for 'neutron_api_use_ssl'

###############################################################################
# BEGIN fix (36 / 36) for 'neutron_file_ownership'
###############################################################################
(>&2 echo "Remediating rule 36/36: 'neutron_file_ownership'")
