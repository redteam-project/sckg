...
# 	$ oscap xccdf generate fix --profile amq-stig --template urn:xccdf:fix:script:sh xccdf-file.xml 
#
...
###############################################################################
# BEGIN fix (12 / 67) for 'jboss_karaf-valid_dod_certificates'
###############################################################################
(>&2 echo "Remediating rule 12/67: 'jboss_karaf-valid_dod_certificates'")
...
###############################################################################
(>&2 echo "Remediating rule 14/67: 'jboss_karaf-enable_fips_authentication'")
...
###############################################################################
# BEGIN fix (16 / 67) for 'jboss_karaf-security_config_attributes'
###############################################################################
(>&2 echo "Remediating rule 16/67: 'jboss_karaf-security_config_attributes'")
...
###############################################################################
# BEGIN fix (17 / 67) for 'jboss_karaf-config_file_permissions'
###############################################################################
(>&2 echo "Remediating rule 17/67: 'jboss_karaf-config_file_permissions'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-config_file_permissions' IS MISSING!")
# END fix for 'jboss_karaf-config_file_permissions'

###############################################################################
# BEGIN fix (18 / 67) for 'jboss_karaf-remove_cleartext_passwords'
###############################################################################
(>&2 echo "Remediating rule 18/67: 'jboss_karaf-remove_cleartext_passwords'")
...
###############################################################################
# BEGIN fix (19 / 67) for 'jboss_karaf-enable_encrypted_passwords'
###############################################################################
(>&2 echo "Remediating rule 19/67: 'jboss_karaf-enable_encrypted_passwords'")
...
###############################################################################
(>&2 echo "Remediating rule 35/67: 'jboss_karaf-system_admin_access'")
...
###############################################################################
# BEGIN fix (54 / 67) for 'jboss_karaf-application_data_flow_docs'
###############################################################################
(>&2 echo "Remediating rule 54/67: 'jboss_karaf-application_data_flow_docs'")
...
###############################################################################
# BEGIN fix (55 / 67) for 'jboss_karaf-incident_response'
###############################################################################
(>&2 echo "Remediating rule 55/67: 'jboss_karaf-incident_response'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-incident_response' IS MISSING!")
# END fix for 'jboss_karaf-incident_response'

###############################################################################
# BEGIN fix (56 / 67) for 'jboss_karaf-physical_protections'
###############################################################################
(>&2 echo "Remediating rule 56/67: 'jboss_karaf-physical_protections'")
...
###############################################################################
# BEGIN fix (58 / 67) for 'jboss_karaf-disaster_recovery_exerises'
###############################################################################
(>&2 echo "Remediating rule 58/67: 'jboss_karaf-disaster_recovery_exerises'")
...
###############################################################################
# BEGIN fix (59 / 67) for 'jboss_karaf-assign_administator'
###############################################################################
(>&2 echo "Remediating rule 59/67: 'jboss_karaf-assign_administator'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-assign_administator' IS MISSING!")
# END fix for 'jboss_karaf-assign_administator'

###############################################################################
# BEGIN fix (60 / 67) for 'jboss_karaf-access_control_docs'
###############################################################################
(>&2 echo "Remediating rule 60/67: 'jboss_karaf-access_control_docs'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-access_control_docs' IS MISSING!")
# END fix for 'jboss_karaf-access_control_docs'

###############################################################################
# BEGIN fix (61 / 67) for 'jboss_karaf-password_length_policy'
###############################################################################
(>&2 echo "Remediating rule 61/67: 'jboss_karaf-password_length_policy'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-password_length_policy' IS MISSING!")
# END fix for 'jboss_karaf-password_length_policy'

###############################################################################
# BEGIN fix (62 / 67) for 'jboss_karaf-deployed_apps-java_perm_docs'
###############################################################################
(>&2 echo "Remediating rule 62/67: 'jboss_karaf-deployed_apps-java_perm_docs'")
...
###############################################################################
(>&2 echo "Remediating rule 65/67: 'jboss_karaf-incident_response_exercises'")
...
###############################################################################
# BEGIN fix (66 / 67) for 'jboss_karaf-disaster_recovery'
###############################################################################
(>&2 echo "Remediating rule 66/67: 'jboss_karaf-disaster_recovery'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-disaster_recovery' IS MISSING!")
# END fix for 'jboss_karaf-disaster_recovery'

###############################################################################
# BEGIN fix (67 / 67) for 'jboss_karaf-password_expiration_policy'
###############################################################################
(>&2 echo "Remediating rule 67/67: 'jboss_karaf-password_expiration_policy'")
