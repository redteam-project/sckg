...
###############################################################################
# BEGIN fix (2 / 20) for 'kubelet_disable_readonly_port'
###############################################################################
(>&2 echo "Remediating rule 2/20: 'kubelet_disable_readonly_port'")
...
###############################################################################
# BEGIN fix (4 / 20) for 'kubelet_enable_server_cert_rotation'
###############################################################################
(>&2 echo "Remediating rule 4/20: 'kubelet_enable_server_cert_rotation'")
(>&2 echo "FIX FOR THIS RULE 'kubelet_enable_server_cert_rotation' IS MISSING!")
# END fix for 'kubelet_enable_server_cert_rotation'

###############################################################################
# BEGIN fix (5 / 20) for 'kubelet_configure_tls_cert'
###############################################################################
(>&2 echo "Remediating rule 5/20: 'kubelet_configure_tls_cert'")
(>&2 echo "FIX FOR THIS RULE 'kubelet_configure_tls_cert' IS MISSING!")
# END fix for 'kubelet_configure_tls_cert'

###############################################################################
# BEGIN fix (6 / 20) for 'kubelet_enable_streaming_connections'
###############################################################################
(>&2 echo "Remediating rule 6/20: 'kubelet_enable_streaming_connections'")
(>&2 echo "FIX FOR THIS RULE 'kubelet_enable_streaming_connections' IS MISSING!")
# END fix for 'kubelet_enable_streaming_connections'

###############################################################################
# BEGIN fix (7 / 20) for 'kubelet_configure_event_creation'
###############################################################################
(>&2 echo "Remediating rule 7/20: 'kubelet_configure_event_creation'")
...
###############################################################################
# BEGIN fix (9 / 20) for 'kubelet_disable_hostname_override'
###############################################################################
(>&2 echo "Remediating rule 9/20: 'kubelet_disable_hostname_override'")
...
###############################################################################
# BEGIN fix (11 / 20) for 'kubelet_disable_cadvisor_port'
###############################################################################
(>&2 echo "Remediating rule 11/20: 'kubelet_disable_cadvisor_port'")
(>&2 echo "FIX FOR THIS RULE 'kubelet_disable_cadvisor_port' IS MISSING!")
# END fix for 'kubelet_disable_cadvisor_port'

###############################################################################
# BEGIN fix (12 / 20) for 'file_owner_node_config'
###############################################################################
(>&2 echo "Remediating rule 12/20: 'file_owner_node_config'")
...
###############################################################################
# BEGIN fix (13 / 20) for 'file_permissions_openshift_node_service'
###############################################################################
(>&2 echo "Remediating rule 13/20: 'file_permissions_openshift_node_service'")

chmod 0644 /etc/systemd/system/atomic-openshift-node.service
# END fix for 'file_permissions_openshift_node_service'

###############################################################################
# BEGIN fix (14 / 20) for 'file_groupowner_node_config'
###############################################################################
(>&2 echo "Remediating rule 14/20: 'file_groupowner_node_config'")
...
###############################################################################
# BEGIN fix (15 / 20) for 'file_groupowner_openshift_node_client_crt'
###############################################################################
(>&2 echo "Remediating rule 15/20: 'file_groupowner_openshift_node_client_crt'")
...
###############################################################################
# BEGIN fix (17 / 20) for 'file_groupowner_openshift_node_service'
###############################################################################
(>&2 echo "Remediating rule 17/20: 'file_groupowner_openshift_node_service'")
...
###############################################################################
# BEGIN fix (20 / 20) for 'file_owner_openshift_node_service'
###############################################################################
(>&2 echo "Remediating rule 20/20: 'file_owner_openshift_node_service'")
