...
bash/all-profile-bash-scripts-fuse6: ssg-fuse6-xccdf.xml
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[fuse6-bash-scripts] generating Bash remediation scripts for all profiles in ssg-fuse6-xccdf.xml"
	cd /root/content-0.1.47/build/fuse6 && /usr/bin/cmake -E make_directory /root/content-0.1.47/build/bash
	cd /root/content-0.1.47/build/fuse6 && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/build_profile_remediations.py --input /root/content-0.1.47/build/ssg-fuse6-xccdf.xml --output /root/content-0.1.47/build/bash --template urn:xccdf:fix:script:sh --extension sh build
	cd /root/content-0.1.47/build/fuse6 && /usr/bin/cmake -E touch /root/content-0.1.47/build/bash/all-profile-bash-scripts-fuse6
...
fuse6/CMakeFiles/generate-all-profile-bash-scripts-fuse6.dir/clean:
	cd /root/content-0.1.47/build/fuse6 && $(CMAKE_COMMAND) -P CMakeFiles/generate-all-profile-bash-scripts-fuse6.dir/cmake_clean.cmake
...
fuse6/CMakeFiles/generate-all-profile-bash-scripts-fuse6.dir/depend:
	cd /root/content-0.1.47/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/content-0.1.47 /root/content-0.1.47/fuse6 /root/content-0.1.47/build /root/content-0.1.47/build/fuse6 /root/content-0.1.47/build/fuse6/CMakeFiles/generate-all-profile-bash-scripts-fuse6.dir/DependInfo.cmake --color=$(COLOR)
