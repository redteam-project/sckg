...
fedora/fixes/bash: ../build-scripts/combine_remediations.py
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "[fedora-content] collecting all bash fixes"
	cd /root/content-0.1.47/build/fedora && env PYTHONPATH=/root/content-0.1.47 /bin/python /root/content-0.1.47/build-scripts/combine_remediations.py --resolved-rules-dir /root/content-0.1.47/build/fedora/rules --build-config-yaml /root/content-0.1.47/build/build_config.yml --product-yaml /root/content-0.1.47/fedora/product.yml --remediation-type bash --output-dir /root/content-0.1.47/build/fedora/fixes/bash /root/content-0.1.47/build/fedora/fixes_from_templates/shared/bash /root/content-0.1.47/build/fedora/fixes_from_templates/bash
...
fedora/CMakeFiles/generate-internal-fedora-bash-all-fixes.dir/clean:
	cd /root/content-0.1.47/build/fedora && $(CMAKE_COMMAND) -P CMakeFiles/generate-internal-fedora-bash-all-fixes.dir/cmake_clean.cmake
...
fedora/CMakeFiles/generate-internal-fedora-bash-all-fixes.dir/depend:
	cd /root/content-0.1.47/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/content-0.1.47 /root/content-0.1.47/fedora /root/content-0.1.47/build /root/content-0.1.47/build/fedora /root/content-0.1.47/build/fedora/CMakeFiles/generate-internal-fedora-bash-all-fixes.dir/DependInfo.cmake --color=$(COLOR)
